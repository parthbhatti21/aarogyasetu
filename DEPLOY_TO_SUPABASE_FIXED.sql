-- ============================================================================
-- HOSPITAL SELECTION FEATURE - FIXED DEPLOYMENT SQL
-- ============================================================================
-- This version handles duplicate hospital IDs in the source data
-- ============================================================================
...
-- ============================================================================
-- 5. MIGRATE DATA FROM EXISTING TABLE (FIXED - Handles Duplicates)
-- ============================================================================
-- This uses DISTINCT ON to keep only the first occurrence of each hospital_id
...
-- Handle hospitals with NULL or empty Hospital Id (create unique IDs)
INSERT INTO public.hospitals (hospital_id, hospital_name, state, district, sl_no)
SELECT 
...
SELECT 
  'Missing hospital_name' as issue,
  COUNT(*) as count
FROM public.hospitals
...
-- Sample data
SELECT hospital_name, state, district, sl_no 
FROM public.hospitals 
...
-- ============================================================================
-- Next steps:
-- 1. Verify hospitals were inserted (check COUNT above)
-- 2. Assign staff to hospitals:
--    UPDATE staff_profiles 
--    SET hospital_id = (SELECT id FROM hospitals WHERE hospital_name = 'Your Hospital')
--    WHERE user_id = 'staff_user_id';
--
-- 3. Test patient registration (should show hospital selection step)
-- 4. Create tokens and verify hospital_id is saved
-- 5. Login as doctor and verify queue filtering
-- ============================================================================
